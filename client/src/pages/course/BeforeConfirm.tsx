...
const courseInfo = [
  [
    {
      ...
      destinationPath: require('../../assets/image/강릉시.jpg'),
      lat: 37.503325874722,
      lng: 127.04403462366,
      markerImage: '',
    },
    {
      ...
      destinationName: '맛있다',
      destinationContent: '하이루',
      destinationPath: require('../../assets/image/속초시.jpg'),
    ...
    },
    {
      ...
      destinationName: '카페다',
      destinationContent: '하이루',
      destinationPath: require('../../assets/image/평창시.jpg'),
  ...
  [
    ...
    },
    {
      ...
      destinationContent: '하이루',
      destinationPath: require('../../assets/image/동해시.jpg'),
