...
const kakaoAuthRemoteURL = `https://kauth.kakao.com/oauth/authorize?client_id=${kakaoRestKey}&redirect_uri=https://j10a305.p.ssafy.io/api/login/oauth2/code/kakao&response_type=code`;
