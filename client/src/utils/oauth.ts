...
const kakaoAuthRemoteURL = `https://kauth.kakao.com/oauth/authorize?client_id=${kakaoRestKey}&redirect_uri=http://i10a305.p.ssafy.io/login/oauth2/code/kakao&response_type=code`;
